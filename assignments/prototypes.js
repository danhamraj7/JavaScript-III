/*
  Object oriented design is commonly used in video games.  For this part of 
  the assignment you will be implementing several constructor functions with their correct 
  ...
  Humanoid.  
  Use the objects at the bottom of the page to test your constructor 
  functions.
...
/*
  === Humanoid (Having an appearance or character resembling that 
    of a human.) ===
  * team
  * weapons
  * language
 ...
 * Instances of CharacterStats should have all of the same properties as 
 * GameObject.
 */

// Test you work by un-commenting these 3 objects and the list of 
//console logs below:
